...
## The correlation between attributes other than the Dependant Variable
```{r}
#install.packages("corrplot")
library(corrplot)

subset_fraudTotal.db <- subset(fraudTotal.db, select = c(3, 6, 13, 14, 15, 16, 20, 21, 22))
...
summary(lm(is_fraud ~ cc_num + amt + zip + lat + long + city_pop + unix_time + merch_lat + merch_long, data = fraudTotal.db))
