...
```{r}
plot(fraudTotal.db$is_fraud, fraudTotal.db$city_pop, main = "Scatterplot of Fraudlent Transactions Based on City Population", xlab = "Fraudulant Transaction", ylab = "City Population", pch = 19)
